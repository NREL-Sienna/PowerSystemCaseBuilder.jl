...
const DATA_DIR = joinpath(dirname(PACKAGE_DIR), "PowerSystemsTestData")  # TODO remove before merging! Kludge to use custom test data until https://github.com/NREL-Sienna/PowerSystemCaseBuilder.jl/issues/54 gets resolved
