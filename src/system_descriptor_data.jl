SYSTEM_CATALOG = [
    SystemDescriptor(;
        ...
        raw_data = from_pstd_data_dir("psy_data", "data_14bus_pu.jl"),
    ...
    SystemDescriptor(;
        ...
        category = PSITestSystems,
        raw_data = from_pstd_data_dir("psy_data", "data_5bus_pu.jl"),
    ...
    SystemDescriptor(;
        ...
        category = PSISystems,
        raw_data = from_pstd_data_dir("psy_data", "data_10bus_ac_dc_pu.jl"),
    ...
    SystemDescriptor(;
        ...
        category = PSISystems,
        raw_data = from_pstd_data_dir("5-Bus"),
    ...
    SystemDescriptor(;
        ...
        raw_data = from_pstd_data_dir("psse_raw", "RTS-GMLC.RAW"),
    ...
    SystemDescriptor(;
        ...
        category = PSITestSystems,
        raw_data = from_pstd_data_dir("RTS_GMLC"),
    ...
    SystemDescriptor(;
        ...
        raw_data = from_pstd_data_dir("matpower", "ACTIVSg2000.m"),
    ...
    SystemDescriptor(;
        ...
        category = MatpowerTestSystems,
        raw_data = from_pstd_data_dir("matpower", "case_ACTIVSg10k.m"),
        build_function = build_matpower,
    ),
    SystemDescriptor(;
        ...
        category = MatpowerTestSystems,
        raw_data = from_pstd_data_dir("matpower", "case2.m"),
        build_function = build_matpower,
    ),
    SystemDescriptor(;
        ...
        description = "Matpower Test system",
        category = MatpowerTestSystems,
        raw_data = from_pstd_data_dir("matpower", "case3_tnep.m"),
        build_function = build_matpower,
    ),
    SystemDescriptor(;
        ...
        description = "Matpower Test system",
        category = MatpowerTestSystems,
        raw_data = from_pstd_data_dir("matpower", "case5_asym.m"),
        build_function = build_matpower,
    ),
    SystemDescriptor(;
        ...
        description = "Matpower Test system",
        category = MatpowerTestSystems,
        raw_data = from_pstd_data_dir("matpower", "case5_dc.m"),
        build_function = build_matpower,
    ),
    SystemDescriptor(;
        ...
        description = "Matpower Test system",
        category = MatpowerTestSystems,
        raw_data = from_pstd_data_dir("matpower", "case5_gap.m"),
        build_function = build_matpower,
    ),
    SystemDescriptor(;
        ...
        description = "Matpower Test system",
        category = MatpowerTestSystems,
        raw_data = from_pstd_data_dir("matpower", "case5_pwlc.m"),
        build_function = build_matpower,
    ),
    SystemDescriptor(;
        ...
        description = "Matpower Test system",
        category = MatpowerTestSystems,
        raw_data = from_pstd_data_dir("matpower", "case5_re_uc_pwl.m"),
        build_function = build_matpower,
    ),
    SystemDescriptor(;
        ...
        description = "Matpower Test system",
        category = MatpowerTestSystems,
        raw_data = from_pstd_data_dir("matpower", "case5_re_uc.m"),
        build_function = build_matpower,
    ),
    SystemDescriptor(;
        ...
        description = "Matpower Test system",
        category = MatpowerTestSystems,
        raw_data = from_pstd_data_dir("matpower", "case5_re.m"),
        build_function = build_matpower,
    ),
    SystemDescriptor(;
        ...
        description = "Matpower Test system",
        category = MatpowerTestSystems,
        raw_data = from_pstd_data_dir("matpower", "case5_tnep.m"),
        build_function = build_matpower,
    ),
    SystemDescriptor(;
        ...
        description = "Matpower Test system",
        category = MatpowerTestSystems,
        raw_data = from_pstd_data_dir("matpower", "case5.m"),
        build_function = build_matpower,
    ),
    SystemDescriptor(;
        ...
        description = "Matpower Test system",
        category = MatpowerTestSystems,
        raw_data = from_pstd_data_dir("matpower", "case6.m"),
        build_function = build_matpower,
    ),
    SystemDescriptor(;
        ...
        description = "Matpower Test system",
        category = MatpowerTestSystems,
        raw_data = from_pstd_data_dir("matpower", "case7_tplgy.m"),
        build_function = build_matpower,
    ),
    SystemDescriptor(;
        ...
        description = "Matpower Test system",
        category = MatpowerTestSystems,
        raw_data = from_pstd_data_dir("matpower", "case14.m"),
        build_function = build_matpower,
    ),
    SystemDescriptor(;
        ...
        description = "Matpower Test system",
        category = MatpowerTestSystems,
        raw_data = from_pstd_data_dir("matpower", "case24.m"),
        build_function = build_matpower,
    ),
    SystemDescriptor(;
        ...
        description = "Matpower Test system",
        category = MatpowerTestSystems,
        raw_data = from_pstd_data_dir("matpower", "case30.m"),
        build_function = build_matpower,
    ),
    SystemDescriptor(;
        ...
        category = MatpowerTestSystems,
        raw_data = from_pstd_data_dir("matpower", "frankenstein_00.m"),
        build_function = build_matpower,
    ),
    SystemDescriptor(;
        ...
        category = MatpowerTestSystems,
        raw_data = from_pstd_data_dir("matpower", "RTS_GMLC.m"),
        build_function = build_matpower,
    ),
    SystemDescriptor(;
        ...
        description = "Matpower Test system",
        category = MatpowerTestSystems,
        raw_data = from_pstd_data_dir("matpower", "case5_strg.m"),
        build_function = build_matpower,
    ),
    SystemDescriptor(;
        name = "pti_case3_sys",
        ...
        category = PSSEParsingTestSystems,
        raw_data = from_pstd_data_dir("psse_raw", "case3.raw"),
    ...
    SystemDescriptor(;
        ...
        category = PSSEParsingTestSystems,
        raw_data = from_pstd_data_dir("psse_raw", "case5_alc.raw"),
        build_function = build_pti,
    ),
    SystemDescriptor(;
        name = "pti_case5_sys",
        ...
        category = PSSEParsingTestSystems,
        raw_data = from_pstd_data_dir("psse_raw", "case5.raw"),
        build_function = build_pti,
    ),
    SystemDescriptor(;
        ...
        category = PSSEParsingTestSystems,
        raw_data = from_pstd_data_dir("psse_raw", "case7_tplgy.raw"),
        build_function = build_pti,
    ),
    SystemDescriptor(;
        name = "pti_case14_sys",
        ...
        category = PSSEParsingTestSystems,
        raw_data = from_pstd_data_dir("psse_raw", "case14.raw"),
        build_function = build_pti,
    ),
    SystemDescriptor(;
        name = "pti_case24_sys",
        ...
        category = PSSEParsingTestSystems,
        raw_data = from_pstd_data_dir("psse_raw", "case24.raw"),
        build_function = build_pti,
    ),
    SystemDescriptor(;
        name = "pti_case30_sys",
        ...
        category = PSSEParsingTestSystems,
        raw_data = from_pstd_data_dir("psse_raw", "case30.raw"),
        build_function = build_pti,
    ),
    SystemDescriptor(;
        name = "pti_case73_sys",
        ...
        category = PSSEParsingTestSystems,
        raw_data = from_pstd_data_dir("psse_raw", "case73.raw"),
        build_function = build_pti,
    ),
    SystemDescriptor(;
        ...
        category = PSSEParsingTestSystems,
        raw_data = from_pstd_data_dir("psse_raw", "frankenstein_00_2.raw"),
        build_function = build_pti,
    ),
    SystemDescriptor(;
        ...
        description = "PSSE frankenstein Test system",
        category = PSSEParsingTestSystems,
        raw_data = from_pstd_data_dir("psse_raw", "frankenstein_00.raw"),
        build_function = build_pti,
    ),
    SystemDescriptor(;
        ...
        description = "PSSE frankenstein Test system",
        category = PSSEParsingTestSystems,
        raw_data = from_pstd_data_dir("psse_raw", "frankenstein_20.raw"),
        build_function = build_pti,
    ),
    SystemDescriptor(;
        ...
        description = "PSSE frankenstein Test system",
        category = PSSEParsingTestSystems,
        raw_data = from_pstd_data_dir("psse_raw", "frankenstein_70.raw"),
        build_function = build_pti,
    ),
    SystemDescriptor(;
        ...
        category = PSSEParsingTestSystems,
        raw_data = from_pstd_data_dir("psse_raw", "parser_test_a.raw"),
        build_function = build_pti,
    ),
    # SystemDescriptor(
    ...
    #     description =  "PSSE Test system",
    #     category =  PSSEParsingTestSystems,
    #     raw_data =  from_pstd_data_dir("psse_raw", "parser_test_b.raw"),
    #     build_function  =  build_pti
    # ),
    # SystemDescriptor(
    ...
    #     description =  "PSSE Test system",
    #     category =  PSSEParsingTestSystems,
    #     raw_data =  from_pstd_data_dir("psse_raw", "parser_test_c.raw"),
    #     build_function  =  build_pti
    # ),
    # SystemDescriptor(
    ...
    #     description =  "PSSE Test system",
    #     category =  PSSEParsingTestSystems,
    #     raw_data =  from_pstd_data_dir("psse_raw", "parser_test_d.raw"),
    #     build_function  =  build_pti
    # ),
    # SystemDescriptor(
    ...
    #     description =  "PSSE Test system",
    #     category =  PSSEParsingTestSystems,
    #     raw_data =  from_pstd_data_dir("psse_raw", "parser_test_e.raw"),
    #     build_function  =  build_pti
    # ),
    # SystemDescriptor(
    ...
    #     description =  "PSSE Test system",
    #     category =  PSSEParsingTestSystems,
    #     raw_data =  from_pstd_data_dir("psse_raw", "parser_test_f.raw"),
    #     build_function  =  build_pti
    # ),
    # SystemDescriptor(
    ...
    #     description =  "PSSE Test system",
    #     category =  PSSEParsingTestSystems,
    #     raw_data =  from_pstd_data_dir("psse_raw", "parser_test_g.raw"),
    #     build_function  =  build_pti
    # ),
    # SystemDescriptor(
    ...
    #     description =  "PSSE Test system",
    #     category =  PSSEParsingTestSystems,
    #     raw_data =  from_pstd_data_dir("psse_raw", "parser_test_h.raw"),
    #     build_function  =  build_pti
    # ),
    # SystemDescriptor(
    ...
    #     description =  "PSSE Test system",
    #     category =  PSSEParsingTestSystems,
    #     raw_data =  from_pstd_data_dir("psse_raw", "parser_test_i.raw"),
    #     build_function  =  build_pti
    # ),
    # SystemDescriptor(
    ...
    #     description =  "PSSE Test system",
    #     category =  PSSEParsingTestSystems,
    #     raw_data =  from_pstd_data_dir("psse_raw", "parser_test_j.raw"),
    #     build_function  =  build_pti
    # ),
    SystemDescriptor(;
        ...
        description = "PSSE Test system",
        category = PSSEParsingTestSystems,
        raw_data = from_pstd_data_dir("psse_raw", "three_winding_mag_test.raw"),
        build_function = build_pti,
    ),
    SystemDescriptor(;
        ...
        description = "PSSE Test system",
        category = PSSEParsingTestSystems,
        raw_data = from_pstd_data_dir("psse_raw", "three_winding_test_2.raw"),
        build_function = build_pti,
    ),
    SystemDescriptor(;
        ...
        description = "PSSE Test system",
        category = PSSEParsingTestSystems,
        raw_data = from_pstd_data_dir("psse_raw", "three_winding_test.raw"),
        build_function = build_pti,
    ),
    SystemDescriptor(;
        ...
        description = "PSSE Test system",
        category = PSSEParsingTestSystems,
        raw_data = from_pstd_data_dir("psse_raw", "two_winding_mag_test.raw"),
        build_function = build_pti,
    ),
    SystemDescriptor(;
        ...
        description = "PSSE Test system",
        category = PSSEParsingTestSystems,
        raw_data = from_pstd_data_dir("psse_raw", "two-terminal-hvdc_test.raw"),
        build_function = build_pti,
    ),
    SystemDescriptor(;
        ...
        description = "PSSE Test system",
        category = PSSEParsingTestSystems,
        raw_data = from_pstd_data_dir("psse_raw", "vsc-hvdc_test.raw"),
        build_function = build_pti,
    ),
    SystemDescriptor(;
        ...
        category = PSSEParsingTestSystems,
        raw_data = from_pstd_data_dir("psse_raw", "synthetic_data_v30.raw"),
    ...
    SystemDescriptor(;
        ...
        raw_data = from_pstd_data_dir("psid_tests", "psse", "AVRs"),
    ...
    SystemDescriptor(;
        ...
        category = PSIDTestSystems,
        raw_data = from_pstd_data_dir("psid_tests", "psse", "TGs"),
    ...
    SystemDescriptor(;
        ...
        category = PSIDTestSystems,
        raw_data = from_pstd_data_dir("psid_tests", "psse", "GENs"),
    ...
    SystemDescriptor(;
        ...
        category = PSIDTestSystems,
        raw_data = from_pstd_data_dir("psid_tests", "psse", "PSSs"),
    ...
    SystemDescriptor(;
        ...
        category = PSIDTestSystems,
        raw_data = from_pstd_data_dir("psid_tests", "data_tests", "OMIB.raw"),
    ...
    SystemDescriptor(;
        ...
        category = PSIDTestSystems,
        raw_data = from_pstd_data_dir("psid_tests", "psse", "LOAD"),
    ...
    SystemDescriptor(;
        ...
        raw_data = from_pstd_data_dir("psid_tests", "psse", "MultiGen"),
    ...
    SystemDescriptor(;
        ...
        category = PSIDSystems,
        raw_data = from_pstd_data_dir("psid_tests", "psse", "ANDES"),
    ...
    SystemDescriptor(;
        ...
        category = PSIDTestSystems,
        raw_data = from_pstd_data_dir("psid_tests", "data_tests"),
    ...
    SystemDescriptor(;
        ...
        category = PSIDSystems,
        raw_data = from_pstd_data_dir("psid_tests", "data_examples"),
    ...
    category = PSISystems,
    raw_data = from_pstd_data_dir("118-Bus", "data_118bus.jl"),
...
SYSTEM_CATALOG_REF[] = SYSTEM_CATALOG
